...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://id-preview--b10952e4-0373-41a9-ae9f-493236d5b3fa.lovable.app/__l5e/assets-v1/98cfaa02-d44e-433a-85c7-7b49a4a1e5f3/portfolio-og.png" },
      { property: "og:image:width", content: "1024" },
      { property: "og:image:height", content: "1024" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:image", content: "https://id-preview--b10952e4-0373-41a9-ae9f-493236d5b3fa.lovable.app/__l5e/assets-v1/98cfaa02-d44e-433a-85c7-7b49a4a1e5f3/portfolio-og.png" },
    ],
  }),
  component: Portfolio,
});
  ...
  return (
    <section id="about" className="mx-auto max-w-6xl px-6 py-24">
      ...
      <div className="max-w-3xl space-y-6">
        ...
        <div className="p-5 rounded-lg bg-surface border border-border shadow-card max-w-md">
